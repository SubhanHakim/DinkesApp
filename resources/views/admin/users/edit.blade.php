            ...
            <div class="p-4">
                <div class="p-6 rounded-4" style="background-color: #ECECEC;">
                    <div class="p-4">
                        ...
                        <div>
                            <form method="POST" action="{{ route('admin.users.updateUser', $user->id) }}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <select id="role" class="form-control" name="role"
                                            ...
                                            <option value="bidang"
                                                {{ old('role', $user->role) == 'bidang' ? 'selected' : '' }}>Bidang
                                            </option>
                                            <option value="kadis"
                                                {{ old('role', $user->role) == 'kadis' ? 'selected' : '' }}>Kadis</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select id="bidang" class="form-control" name="bidang">
                                            <option value="p2p"
                                                {{ old('bidang', $user->bidang) == 'p2p' ? 'selected' : '' }}>P2P
                                            </option>
                                            <option value="sdk"
                                                {{ old('bidang', $user->bidang) == 'sdk' ? 'selected' : '' }}>SDK
                                            </option>
                                            <option value="kesmas"
                                                {{ old('bidang', $user->bidang) == 'kesmas' ? 'selected' : '' }}>Kesmas
                                            </option>
                                            <option value="yankes"
                                                {{ old('bidang', $user->bidang) == 'yankes' ? 'selected' : '' }}>Yankes
                                            </option>
                                        </select>
                                        @error('bidang')
                                            <div>{{ $message }}</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" id="program" name="program"
                                            value="{{ old('program', $user->program) }}" required>
                                        @error('program')
                                            <div>{{ $message }}</div>
                                        @enderror
                                    </div>
